#ifndef _TOOLS_BALANCE_PLUS_TREE_UTIL_BASE_DEBUG2_H_
#define _TOOLS_BALANCE_PLUS_TREE_UTIL_BASE_DEBUG2_H_
...
public:
    BalancePlusTree_Util(int m) : m_(m), m_half_(m % 2 == 0 ? m/2 : m/2 + 1)
    {
    }
