#ifndef _TOOLS_BALANCE_TREE_UTIL_BASE_H_
#define _TOOLS_BALANCE_TREE_UTIL_BASE_H_
...
public:
    ...
    BalanceTree_Util(const BalanceTree_Util& rhs)
    {
        copy(rhs);
    }

    void copy(const BalanceTree_Util& rhs)
    {
        m_ = rhs.m_;
        m_half_ = rhs.m_half_;
    }
